const lessonText = "gf ggf gf ggf hj hhj hj hhj gfgf hjhj gggf hhhj fghj fgf jhj fgfgf jhjhj ggf hhj gghh ghgh ghfj ggf hhj";
...
const fingerMap = {
    'a': { id: 'leftPinky', colorClass: 'active-pinky' },
    ';': { id: 'rightPinky', colorClass: 'active-pinky' },
    'g': { id: 'leftIndex', colorClass: 'active-index' },
    'h': { id: 'rightIndex', colorClass: 'active-index' },
...
function nextLesson() {
    const nextLevelPath = "index9.html";
